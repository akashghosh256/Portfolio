...
const Data = () => {
  return (
    <div className="home__data">
        ...
        Java Full Stack Developer committed to innovative design and comprehensive solutions, seamlessly integrating robust back-end functionality with intuitive front-end aesthetics.
        </p>
